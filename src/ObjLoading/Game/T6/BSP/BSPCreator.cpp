...
namespace BSP
{
    std::unique_ptr<BSPData> CreateBSPData(const std::string& mapName, ISearchPath& searchPath, const ZoneDefinitionMapType mapType)
    {
        ...
        bsp->name = mapName;
        bsp->mapType = mapType;
        // T6 world assets are conventionally looked up from maps/mp even for
        // non-traditional multiplayer map names such as zm_* and mp_drone.
